...
/*
SYNTAX:
We make a variable like: [a]  and store data in it like [a] contains values - 10, 20, 30, 40...etc in {}
written as -> [a] = {10, 20, 30, 40};
here a[0] - 10, a[1] - 20, a[2] - 30 and so on... a[n] where n refers to the index which we are reffering to
and indexing (n) always starts form 0 to n. 
*/

#include<stdio.h>
int main(){
    int arr[5] = {1, 2, 3, 4, 5};
    printf("Value of 2nd index = %d\n",arr[2]);    // while printing arr[2] here 2 in the [] means it is indexing 2nd value which is 3rd element according to us.
